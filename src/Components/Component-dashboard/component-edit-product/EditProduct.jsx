...
const EditProduct = () => {
    ...
    return (
        <form className="row g-3 col-10 mx-auto" onSubmit={handleSubmit} method='POST' encType="multipart/form-data">
            ...
            <div className="">
                <label for="formFile" className="form-label fw-semibold">Picture <span className="text-danger">*</span></label>
            ...
            <div className="col-md-4">
                <label className="form-label fw-semibold">price (dh) <span className="text-danger">*</span></label>
                <input type="number" className="form-control" name='price' value={price} onChange={(e) => setPrice(e.target.value)} required />
            </div>
            <div className="col-md-4">
                <label className="form-label fw-semibold">Discount rate (%)</label>
            ...
            <div className="col-12 d-flex justify-content-end mt-4">
                <button type="submit" className="btn btn-warning px-4 fw-semibold ">Submit</button>
            </div>
        </form>
    )
}
