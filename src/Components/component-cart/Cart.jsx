                            ...
                            <div className="col-12 mt-2 p-4 shadow-sm" key={item.id}>
                                <div className="row">
                                    ...
                                    <div className="col-3 text-end">
                                        <h4 className="text-warning fw-semibold">{item.promotion_price}.00 Dh</h4>
                                        <h5 className="text-success "> -{item.discount_rate}%</h5>
                                        <h6 className="text-danger "><del>{item.price}.00 Dh</del> </h6>
                                    </div>
                                </div>
                                <div className="d-flex justify-content-between mt-3">
                                    ...
                                    <div>
                                        ...
                                        <button disabled={item.quantity === item.stock} onClick={() => updateItemQuantity(item.id, item.quantity + 1)} className="btn btn-warning fw-semibold">+</button>
                                    </div>
                                </div>
                            </div>
                        ))}
